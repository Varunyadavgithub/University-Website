...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "3c705d95-0280-458a-8bbc-43c6994ba46c");
  ...
  return (
    <div className='contact'>
      <div className="contact-col">
        ...
        <ul>
            <li><img src={mail_icon} alt="e-mail-icon" />Contact@GreatStack.dev</li>
            <li><img src={phone_icon} alt="phone-icon" />+1 123-456-7890</li>
            <li><img src={location_icon} alt="location-icon" />56 Massachusetts Ave, Cambridge <br/> MA 03245, United States</li>
        </ul>
      </div>
      <div className="contact-col">
